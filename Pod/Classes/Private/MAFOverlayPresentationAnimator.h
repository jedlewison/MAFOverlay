 ...
 */
@interface MAFOverlayPresentationAnimator : NSObject <UIViewControllerAnimatedTransitioning, MAFOverlayPresentationContext>
 ...
 */
+ (instancetype)overlayPresentationAnimatorWithDataSource:(id<MAFOverlayPresentationDataSource>)dataSource
